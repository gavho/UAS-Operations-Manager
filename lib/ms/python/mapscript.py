...
class imageObj(object):
    ...
    def pasteImage(self, imageSrc, opacity=1.0, dstx=0, dsty=0):
        return _mapscript.imageObj_pasteImage(self, imageSrc, opacity, dstx, dsty)

    def saveWebImage(self):
...
class errorObj(object):
    ...
    http_status = property(_mapscript.errorObj_http_status_get, _mapscript.errorObj_http_status_set)
...
class projectionObj(object):
    ...
    generation_number = property(_mapscript.projectionObj_generation_number_get)
...
class reprojectionObj(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    generation_number_in = property(_mapscript.reprojectionObj_generation_number_in_get, _mapscript.reprojectionObj_generation_number_in_set)
    generation_number_out = property(_mapscript.reprojectionObj_generation_number_out_get, _mapscript.reprojectionObj_generation_number_out_set)
